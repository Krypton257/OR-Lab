...
{
    int n, m;
    cout << "Enter number of Factorys : ";
    cin >> m;
    cout << "Enter number of Warehouses : ";
    cin >> n;

    double *a = new double[m];          // Stores the Factory Requirements of the Factories
    double *b = new double[n];          // Stores the Warehouse Requirements of the Warehouses
    ...
    cout << "-- INPUT Factory Capacity --\n";
    for (int i = 0; i < m; i++)
    {
        cout << "Capacity at Factory " << i + 1 << " :";
        cin >> a[i];
        asum += a[i];
    }
    ...
    for (int i = 0; i < n; i++)
    {
        cout << "Requirement at Warehouse " << i + 1 << " :";
        cin >> b[i];
        bsum += b[i];
    }
    ...
    double **c = new double *[m];           // Stores the Quantity of Factory from Factory i to Warehouse j in Matrix Form
    for (int i = 0; i < m; i++)
    {
        c[i] = new double[n];
    }
    cout << "Enter Quantity of Factory i to be shipped to the Warehouse j from the Factory i in Matrix Form\n";
    for (int i = 0; i < m; i++)
    {
        for (int j = 0; j < n; j++)
        {
