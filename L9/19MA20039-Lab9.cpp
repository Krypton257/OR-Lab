...
void LeastQuantityCellMethod(double *a, double *b, double **c, int m, int n, double **x)    // Finds the BFS using LCM method
{
    ...
    cout << "\nThe BFS from the Least Quantity Cell method is : " << sum << "\n";
}
...
int main()
{
    ...
    LeastQuantityCellMethod(a, b, c, m, n, x);
    printTable(a, b, c, m, n, x);
